...
#ifndef QUARK_ATOMIC_ATOMIC_HPP_INCLUDED_
#define QUARK_ATOMIC_ATOMIC_HPP_INCLUDED_

#include <quark/atomic/capabilities.hpp>
#include <quark/atomic/fences.hpp>
#include <quark/atomic/atomic_flag.hpp>
#include <quark/atomic/detail/atomic_template.hpp>
...
#endif // QUARK_ATOMIC_ATOMIC_HPP_INCLUDED_
