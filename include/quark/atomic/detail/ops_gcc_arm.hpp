...
#ifndef QUARK_ATOMIC_DETAIL_OPS_GCC_ARM_HPP_INCLUDED_
#define QUARK_ATOMIC_DETAIL_OPS_GCC_ARM_HPP_INCLUDED_
...
#define QUARK_ATOMIC_DETAIL_ARM_ASM_START(TMPREG) "adr " #TMPREG ", 8f\n" "bx " #TMPREG "\n" ".arm\n" ".align 4\n" "8:\n"
#define QUARK_ATOMIC_DETAIL_ARM_ASM_END(TMPREG)   "adr " #TMPREG ", 9f + 1\n" "bx " #TMPREG "\n" ".thumb\n" ".align 2\n" "9:\n"
#define QUARK_ATOMIC_DETAIL_ARM_ASM_TMPREG_CONSTRAINT(var) "=&l" (var)
#else
// The tmpreg may be wasted in this case, which is non-optimal.
#define QUARK_ATOMIC_DETAIL_ARM_ASM_START(TMPREG)
#define QUARK_ATOMIC_DETAIL_ARM_ASM_END(TMPREG)
#define QUARK_ATOMIC_DETAIL_ARM_ASM_TMPREG_CONSTRAINT(var) "=&r" (var)
#endif
...
struct gcc_arm_operations_base
{
    ...
    {
#if defined(QUARK_ATOMIC_DETAIL_ARM_HAS_DMB)
        ...
        __asm__ __volatile__
        (
            QUARK_ATOMIC_DETAIL_ARM_ASM_START(%0)
            "mcr\tp15, 0, r0, c7, c10, 5\n"
            QUARK_ATOMIC_DETAIL_ARM_ASM_END(%0)
            : "=&l" (tmp)
            :
            : "memory"
        );
...
#if defined(QUARK_ATOMIC_DETAIL_ARM_HAS_LDREXD_STREXD)
    ...
    public gcc_arm_operations_base
{
    ...
    static QUARK_FORCEINLINE storage_type load(storage_type const volatile& storage, memory_order order) QUARK_NOEXCEPT
    {
        ...
        (
            ...
            "ldrexd %1, %H1, [%2]\n"
            QUARK_ATOMIC_DETAIL_ARM_ASM_END(%0)
            : QUARK_ATOMIC_DETAIL_ARM_ASM_TMPREG_CONSTRAINT(tmp), // %0
              "=&r" (original)   // %1
            : "r" (&storage)     // %2
        );
        fence_after(order);
...
#endif // defined(QUARK_ATOMIC_DETAIL_ARM_HAS_LDREXD_STREXD)
...
#endif // QUARK_ATOMIC_DETAIL_OPS_GCC_ARM_HPP_INCLUDED_
