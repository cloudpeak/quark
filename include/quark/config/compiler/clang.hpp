...
#if !__has_feature(cxx_exceptions) && !defined(QUARK_NO_EXCEPTIONS)
#  define QUARK_NO_EXCEPTIONS
#endif

#if !__has_feature(cxx_rtti) && !defined(QUARK_NO_RTTI)
#  define QUARK_NO_RTTI
#endif

#if !__has_feature(cxx_rtti) && !defined(QUARK_NO_TYPEID)
...
// See https://svn.quark.org/trac/quark/ticket/10418
...
//
// The QUARK_FALLTHROUGH macro can be used to annotate implicit fall-through
// between switch labels.
//
#if __cplusplus >= 201103L && defined(__has_warning)
#  if __has_feature(cxx_attributes) && __has_warning("-Wimplicit-fallthrough")
#    define QUARK_FALLTHROUGH [[clang::fallthrough]]
#  endif
#endif
...
// creating the Clang release (see https://github.com/quarkorg/config/pull/39#issuecomment-59927873)
...
#  define QUARK_COMPILER "Clang version " __clang_version__
#endif

// Macro used to identify the Clang compiler.
#define QUARK_CLANG 1
