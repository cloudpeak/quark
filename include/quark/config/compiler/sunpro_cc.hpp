...
#      define QUARK_NO_MEMBER_TEMPLATES
...
#      define QUARK_NO_TEMPLATE_TEMPLATES
       // see http://lists.quark.org/MailArchives/quark/msg47184.php
       // and http://lists.quark.org/MailArchives/quark/msg47220.php
#      define QUARK_NO_INCLASS_MEMBER_INITIALIZATION
...
//
#if __SUNPRO_CC > 0x500
#  define QUARK_SYMBOL_EXPORT __global
#  define QUARK_SYMBOL_IMPORT __global
#  define QUARK_SYMBOL_VISIBLE __global
#endif
...
#define QUARK_COMPILER "Sun compiler version " QUARK_STRINGIZE(__SUNPRO_CC)
