...
#ifdef __FreeBSD__
#define QUARK_PLATFORM "FreeBSD " QUARK_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define QUARK_PLATFORM "NetBSD " QUARK_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define QUARK_PLATFORM "OpenBSD " QUARK_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define QUARK_PLATFORM "DragonFly " QUARK_STRINGIZE(__DragonFly__)
#endif
...
#  define QUARK_NO_CTYPE_FUNCTIONS
#endif
