...
//  Since WRS does not yet properly support quark under vxWorks
//  and this file was badly outdated, but I was keen on using it,
//  I patched quark myself to make things work. This has been tested
...
//  absolutely unable to use quark. This is mainly due to the completely
...
//  with the usage of quark from DKMs. WRS or any voluteers are free to
//  prove the opposite!
...
//
// a) Patch every piece of quark that uses semaphores to instanciate
...
//    too easily, as with every new version some quark library could
...
//    as it will more or less seamlessly integrate with quark. I got
...
//   with the changed properties. That's it! Now, using quark should
...
#  error "The vxWorks version you're using is so badly outdated,\
          it doesn't work at all with quark, sorry, no chance!"
#endif

// Handle versions above 5.X but below 6.9
#if (_WRS_VXWORKS_MAJOR == 6) && (_WRS_VXWORKS_MINOR < 9)
// TODO: Starting from what version does vxWorks work with quark?
// We can't reasonably insert a #warning "" as a user hint here,
// as this will show up with every file including some quark header,
// badly bugging the user... So for the time being we just leave it.
#endif

// vxWorks specific config options:
// --------------------------------
#define QUARK_PLATFORM "vxWorks"
...
// Generally unavailable functionality, delivered by quark's test function:
//#define QUARK_NO_DEDUCED_TYPENAME // Commented this out, quark's test gives an errorneous result!
