...
#if defined(__GNUC__) && !defined(QUARK_NO_SWPRINTF)
#  define QUARK_NO_SWPRINTF
#endif

//  Default defines for QUARK_SYMBOL_EXPORT and QUARK_SYMBOL_IMPORT
//  If a compiler doesn't support __declspec(dllexport)/__declspec(dllimport),
//  its quark/config/compiler/ file must define QUARK_SYMBOL_EXPORT and
//  QUARK_SYMBOL_IMPORT
#ifndef QUARK_SYMBOL_EXPORT
#  define QUARK_HAS_DECLSPEC
#  define QUARK_SYMBOL_EXPORT __declspec(dllexport)
#  define QUARK_SYMBOL_IMPORT __declspec(dllimport)
#endif
...
// we used to disable this when QUARK_DISABLE_WIN32 was 
// defined but no longer - this should allow some
// files to be compiled in strict mode - while maintaining
// a consistent setting of QUARK_HAS_THREADS across
...
#  define QUARK_NO_ANSI_APIS
// Windows CE does not have a conforming signature for swprintf
#  define QUARK_NO_SWPRINTF
#else
#  define QUARK_HAS_GETSYSTEMTIMEASFILETIME
#  define QUARK_HAS_THREADEX
#  define QUARK_HAS_GETSYSTEMTIMEASFILETIME
#endif

#ifndef QUARK_DISABLE_WIN32
// WEK: Added
