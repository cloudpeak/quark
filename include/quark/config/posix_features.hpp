...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(QUARK_HAS_WINTHREADS) && !defined(QUARK_HAS_MPTASKS)
...
#     endif
      ...
      // QUARK_HAS_GETTIMEOFDAY:
      // QUARK_HAS_PTHREAD_MUTEXATTR_SETTYPE:
