...
#  endif
#  if !(defined(_HAS_MEMBER_TEMPLATES_REBIND) && (_HAS_MEMBER_TEMPLATES_REBIND+0 > 0)) && !(defined(_MSC_VER) && (_MSC_VER > 1300)) && defined(QUARK_MSVC)
#     define QUARK_NO_STD_ALLOCATOR
#  endif
#  define QUARK_HAS_PARTIAL_STD_ALLOCATOR
#  if defined(QUARK_MSVC) && (QUARK_MSVC < 1300)
...
// and no <slist> at all
#else
#  define QUARK_MSVC_STD_ITERATOR 1
...
#  define QUARK_STD_EXTENSION_NAMESPACE stdext
#endif
...
#if !_HAS_EXCEPTIONS && ((defined(QUARK_MSVC) && QUARK_MSVC >= 1400) || (defined(__clang__) && defined(_MSC_VER)))
#include <exception>
#endif
#include <typeinfo>
...
#if ((!defined(_HAS_TR1_IMPORTS) || (_HAS_TR1_IMPORTS+0 == 0)) && !defined(QUARK_NO_CXX11_HDR_TUPLE)) \
...
#if defined(QUARK_INTEL) && (QUARK_INTEL <= 1400)
...
#ifdef _CPPLIB_VER
#  define QUARK_DINKUMWARE_STDLIB _CPPLIB_VER
#else
#  define QUARK_DINKUMWARE_STDLIB 1
#endif

#ifdef _CPPLIB_VER
#  define QUARK_STDLIB "Dinkumware standard library version " QUARK_STRINGIZE(_CPPLIB_VER)
#else
#  define QUARK_STDLIB "Dinkumware standard library version 1.x"
#endif
