...
#define QUARK_GNU_STDLIB 1

#ifdef __GLIBCXX__
#define QUARK_STDLIB "GNU libstdc++ version " QUARK_STRINGIZE(__GLIBCXX__)
#else
#define QUARK_STDLIB "GNU libstdc++ version " QUARK_STRINGIZE(__GLIBCPP__)
#endif
...
#  define QUARK_STD_EXTENSION_NAMESPACE __gnu_cxx
#  define QUARK_HAS_SLIST
#  define QUARK_HAS_HASH
#  define QUARK_SLIST_HEADER <ext/slist>
# if !defined(__GNUC__) || __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 3)
#   define QUARK_HASH_SET_HEADER <ext/hash_set>
#   define QUARK_HASH_MAP_HEADER <ext/hash_map>
# else
#   define QUARK_HASH_SET_HEADER <backward/hash_set>
#   define QUARK_HASH_MAP_HEADER <backward/hash_map>
# endif
#endif
...
//  only ever claims to emulate GCC-4.2, see https://svn.quark.org/trac/quark/ticket/7473
...
#  define QUARK_LIBSTDCXX_VERSION 50100
#elif __has_include(<shared_mutex>)
#  define QUARK_LIBSTDCXX_VERSION 40900
#elif __has_include(<ext/cmath>)
#  define QUARK_LIBSTDCXX_VERSION 40800
#elif __has_include(<scoped_allocator>)
#  define QUARK_LIBSTDCXX_VERSION 40700
#elif __has_include(<typeindex>)
#  define QUARK_LIBSTDCXX_VERSION 40600
#elif __has_include(<future>)
#  define QUARK_LIBSTDCXX_VERSION 40500
#elif  __has_include(<ratio>)
#  define QUARK_LIBSTDCXX_VERSION 40400
#elif __has_include(<array>)
#  define QUARK_LIBSTDCXX_VERSION 40300
#endif
//
...
#if !defined(QUARK_LIBSTDCXX_VERSION)
#  define QUARK_LIBSTDCXX_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif

//  C++0x headers in GCC 4.3.0 and later
//
#if (QUARK_LIBSTDCXX_VERSION < 40300) || !defined(QUARK_LIBSTDCXX11)
...
//
#if (QUARK_LIBSTDCXX_VERSION < 40400) || !defined(QUARK_LIBSTDCXX11)
...
#else
#  define QUARK_HAS_TR1_COMPLEX_INVERSE_TRIG 
#  define QUARK_HAS_TR1_COMPLEX_OVERLOADS 
#endif

//  C++0x features in GCC 4.5.0 and later
//
#if (QUARK_LIBSTDCXX_VERSION < 40500) || !defined(QUARK_LIBSTDCXX11)
...
//
#if (QUARK_LIBSTDCXX_VERSION < 40600) || !defined(QUARK_LIBSTDCXX11)
...
//
#if (QUARK_LIBSTDCXX_VERSION < 40700) || !defined(QUARK_LIBSTDCXX11)
...
//
#if (QUARK_LIBSTDCXX_VERSION < 40800) || !defined(QUARK_LIBSTDCXX11)
...
//
#if (QUARK_LIBSTDCXX_VERSION < 40900) || !defined(QUARK_LIBSTDCXX11)
...
//
#if (QUARK_LIBSTDCXX_VERSION < 50100) || !defined(QUARK_LIBSTDCXX11)
...
#  define QUARK_NO_CXX14_HDR_SHARED_MUTEX
#endif
#elif __cplusplus < 201402 || (QUARK_LIBSTDCXX_VERSION < 40900) || !defined(QUARK_LIBSTDCXX11)
#  define QUARK_NO_CXX14_HDR_SHARED_MUTEX
#endif
...
#  ifndef QUARK_NO_CXX11_HDR_CONDITION_VARIABLE
#     define QUARK_NO_CXX11_HDR_CONDITION_VARIABLE
#  endif
#  ifndef QUARK_NO_CXX11_HDR_MUTEX
#     define QUARK_NO_CXX11_HDR_MUTEX
#  endif
#  ifndef QUARK_NO_CXX11_HDR_THREAD
#     define QUARK_NO_CXX11_HDR_THREAD
#  endif
#  ifndef QUARK_NO_CXX14_HDR_SHARED_MUTEX
#     define QUARK_NO_CXX14_HDR_SHARED_MUTEX
#  endif
#endif

#if (!defined(_GTHREAD_USE_MUTEX_TIMEDLOCK) || (_GTHREAD_USE_MUTEX_TIMEDLOCK == 0)) && !defined(QUARK_NO_CXX11_HDR_MUTEX)
