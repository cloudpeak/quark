...
#     define QUARK_NO_LIMITS
// Note: <quark/limits.hpp> will provide compile-time constants
#     undef QUARK_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#define QUARK_STDLIB "SGI standard library"