#ifndef QUARK_MEMORY_ORDER_HPP_INCLUDED
#define QUARK_MEMORY_ORDER_HPP_INCLUDED
...
//  quark/memory_order.hpp
//
//  Defines enum quark::memory_order per the C++0x working draft
//
...
#endif // #ifndef QUARK_MEMORY_ORDER_HPP_INCLUDED
